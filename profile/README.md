...
도시재생지원센터는 다양한 정보(센터 소개, 사업 안내, 공지사항 등)를 제공하지만, 웹사이트 구조상 원하는 정보를 빠르게 찾기 어려운 경우가 있습니다.  

또한, 기존 정보 제공 방식에는 다음과 같은 문제가 존재했습니다:
1. **시민 정보 접근성 저하** – 원하는 정보를 찾기 위해 여러 메뉴 탐색이 필요  
2. **행정업무 과부하** – 반복적인 민원 응대에 행정 인력이 소모  
3. **정보 전달의 비효율성** – 전화·현장·온라인 등 채널이 분산되어 즉각적 확인이 어려움  

이를 해결하기 위해 **호동이 챗봇**은 사용자의 질문을 이해하고, 관련 정보를 신속하게 제공하여 **시민 친화적인 정보 접근성**을 높이고자 합니다.
